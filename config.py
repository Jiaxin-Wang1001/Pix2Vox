...
__C.DATASETS.SHAPENET.RENDERING_PATH        = '/content/drive/MyDrive/414project/ShapeNetRendering/%s/%s/rendering/%02d.png'
# __C.DATASETS.SHAPENET.RENDERING_PATH      = '/home/hzxie/Datasets/ShapeNet/PascalShapeNetRendering/%s/%s/render_%04d.jpg'
__C.DATASETS.SHAPENET.VOXEL_PATH            = '/content/drive/MyDrive/414project/ShapeNetVox32/%s/%s/model.binvox'
__C.DATASETS.SHAPENET.PROJECTION_PATH       = '/content/drive/MyDrive/414project/ShapeNetVox32/%s/%s/%01d.png'
